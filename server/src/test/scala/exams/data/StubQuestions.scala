...
import exams.shared.data.{Answer, BlankQuestion, Question}
...
object StubQuestions {
  ...
  val completedExam: CompletedExam = CompletedExam("exam123", List(List(Answer("1"), Answer("2")), List(Answer("yes"))))
}
